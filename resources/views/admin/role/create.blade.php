    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18">افزودن نقش</h4>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" style="height: 400px;" name="permissions[]" multiple="multiple">
                                        @foreach($permissions as $permission)
                                            <option value="{{$permission->id}}" @if(old('permissions')){{{ in_array(trim($permission->id) , old('permissions')) ? 'selected' : ''  }}} @endif >{{$permission->name}}</option>
                                        @endforeach
